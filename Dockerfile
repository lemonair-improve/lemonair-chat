...
ARG CHAT_SERVER_IP="3.37.69.208"

RUN sed -i 's/profiler.transport.grpc.collector.ip=127.0.0.1/profiler.transport.grpc.collector.ip=52.78.143.61/g' /usr/local/pinpoint-agent-2.5.3/pinpoint-root.config
RUN sed -i 's/profiler.collector.ip=127.0.0.1/profiler.collector.ip=52.78.143.61/g' /usr/local/pinpoint-agent-2.5.3/pinpoint-root.config
